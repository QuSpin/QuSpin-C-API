...
class basis:
    ...
    @staticmethod
    def emit_on_the_fly_operator_string(codes, bitbasis:str):
        cases = {}
    ...
    @staticmethod
    def emit_calc_rowptr(codes, bitbasis:str):
        cases = {}
    ...
    @staticmethod
    def emit_calc_matrix(codes, bitbasis:str):
        cases = {}
    ...
    @staticmethod
    def emit_build_subspace_terms(codes, bitbasis:str):
        cases = {}
