...
class basis_abi:
    ...
    def emit_basis_abi_body(int_types:list,boost_types:list) -> str:
        typedefs=basis_abi.emit_basis_abi_typedefs(int_types,boost_types)
        bosonic_basis_class = basis_abi.bosonic_basis(int_types,boost_types).emit()
        anyonic_basis_class = basis_abi.anyonic_basis(int_types,boost_types).emit()
    ...
    def emit(use_boost:bool) -> str:
        ...
        basis_abi_body = basis_abi.emit_basis_abi_body(int_types,boost_types)
...
class operator_abi:
    ...
    def emit_operator_abi_body() -> str:
        typedefs = operator_abi.emit_operator_abi_typedefs()
        operator_class = operator_abi.operator().emit()
        return f"""
    {typedefs}
    // abi class definitions
    {operator_class}
    ...
    namespace quspin_core_abi {{
    {operator_abi.emit_operator_abi_body()}
    }}
    #endif"""    
...
class symmetry_abi:
    ...
    def emit_symmetry_abi_body(use_boost:bool):
        ...
        typedefs = symmetry_abi.emit_symmetry_abi_typedefs()
        symmetry_class = symmetry_abi.symmetry(int_types+boost_types).emit()
        return f"""
    {typedefs}
    ...
    @staticmethod
    def emit(use_boost:bool):
        symmetry_abi_body = symmetry_abi.emit_symmetry_abi_body(use_boost)
